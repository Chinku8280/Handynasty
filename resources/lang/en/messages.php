...
return array (
  ...
  array (
    ...
    'keepBlankForwithoutMinimumAmount' => 'Keep blank for apply on all spending amount.',
  ...
  'howManyTimeCustomerCanUsePromotion' => 'How many times a single customer can use this promotion',
  'limit' => 'How many times can be use.(Keep blank for infinite use)',
  'dealLimit' => 'How many times deal can be use.(Keep blank for infinite use)',
  'voucherLimit' => 'How many times Voucher can be use.(Keep blank for infinite use)',
  'max_person' => 'How many times Offer can be use.(Keep blank for infinite use)',
  ...
  'packageAlreadyAssigned' => 'This Package already assigned to the user',
);
