...
<div class="wrapper">
            ...
            <div class="col-sm-10">             
                @if($user->is_employee)
                    @if (!empty($outlet->outlet_name))
                        <h5 style="color: #fff; margin-top: 10px; margin-left: 10px;">{{$outlet->outlet_name}}</h5>
                    @endif                 
                @endif                      
            </div>
            ...
            <div class="col-sm-2">
                <ul class="navbar-nav ml-auto pull-right">
                    ...
                    <li class="profile-dropdown">
                        <form id="logout-form" action="{{ route('pos.logout', $outlet->outlet_slug ?? '') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
                        </form>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="{{ route('pos.logout', $outlet->outlet_slug ?? '') }}" title="Logout" onclick="event.preventDefault();
    ...
    <aside class="main-sidebar sidebar-dark-danger">
        <!-- Brand Logo -->
        <a href="{{ route('pos.dashboard', request()->route('outlet_slug')) }}" class="brand-link">
