        ...
        <div class="col-md-4">
            <div class="pos-btn">
                @if (Session::has('open_session'))
                    <a href="{{route('pos.pos', $outlet->outlet_slug)}}" class="btn btn-custom btn-lg">Continue Sessions</a>
                @else
                    <a href="{{route('pos.pos', $outlet->outlet_slug)}}" class="btn btn-custom btn-lg">Start Sessions</a>
                @endif
            </div>
        </div>
    </div>
