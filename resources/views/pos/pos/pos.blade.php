...
@section('content')
    ...
    @if(!Session::has('open_session'))
    <!-- open session modal -->
    <div class="modal fade" id="open_session_modal" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="open_session_form" method="POST" action="">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-4">
                                <input type="text" name="open_cash" class="modal-form form-control" placeholder="" required>
                            </div>
                            <div class="col-2">
                                <a href="#" style="font-size: 25px; color: #531717;"><i class="fa fa-calculator"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for=""></label>
                                    <textarea name="open_note" cols="30" rows="10" class="form-control"
                                        style="height: 90px;" placeholder="Add an opening note"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer" style="justify-content: end;">
                        <button type="submit" class="btn btn-success">Open Sessions</button>
                    </div>
...
@push('footer-js')
    ...
    <script>
        ...
        //     $('body').on('submit', '#open_session_form', function (e) {

        //         e.preventDefault();

        //         $.ajax({
        //             type: "post",
        //             url: "{{route('pos.open-session')}}",
        //             data: $(this).serialize(),
        ...
        //                     $('#open_session_form')[0].reset();
        //                     $("#open_session_form").modal('hide');
