                    ...
                    <form role="form" id="editForm"  class="ajax-form" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mt-3">
                                    @if ($deal->image)
                                    <img src="{{ asset('user-uploads/deal/'.$deal->image)  }}" width="150" class="img-thumbnail">
                                    @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <input type="file" id="input-file-now" name="feature_image" accept=".png,.jpg,.jpeg" data-default-file="{{ asset('user-uploads/deal/'.$deal->image)  }}" class="form-control"
                                            />
                                        </div>
                                    </div>
                                </div>
