...
<div class="modal fade bs-modal-lg in" id="feedback-detail-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" id="modal-data-application">
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title">@lang('app.feedback')</h4>
...
<script>
    $(document).ready(function() {
            ...
            $('body').on('click', '.view-feedback', function() {
                ...
                $('#modelHeading').html('Show Feedback');
                $.ajaxModal('#feedback-detail-modal', url);
            });
