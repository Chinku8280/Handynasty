...
@push('footer-js')
    ...
    <script>
        ...
        //                 {
        //                     var html = `<a href="#">
        //                                     <div class="coin_box" style="background-color: #380814;"><span class='span_reward_class'></span></div>    
        //                                 </a>`;
        ...
        //                     var html = `<a href="#">
        //                                     <div class="coin_box" style="background: linear-gradient(90deg, #380814 50%, white 50%);"><span class='span_reward_class'></span></div>    
        //                                 </a>`;
