                    ...
                    <form role="form" id="createForm"  class="ajax-form" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="mt-3">
                                        <img src="{{ $user->user_image_url  }}" width="150" alt="" class="img-thumbnail">
                                    </div>
                                    <div class="form-group mt-3">
                                        <label for="exampleInputPassword1">@lang('app.image')</label>
                                        <div class="card">
                                            <div class="card-body">
                                                <input type="file" id="input-file-now" name="image" accept=".png,.jpg,.jpeg" data-default-file="{{ $user->user_image_url  }}" class="form-control"
                                                />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <button type="button" id="save-form" class="btn btn-success btn-light-round"><i class="fa fa-check"></i> @lang('app.save')</button>
                                </div>
