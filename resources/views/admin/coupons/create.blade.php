    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-dark">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" id="createForm" class="ajax-form" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="coupon_code" value="" autocomplete="off" required>
                                </div>
                            </div>        
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <span
                                        class="help-block">@lang('messages.coupon.forAmountDiscountOrMaximumDiscount')</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <!-- text input -->
                                        ...
                                        <div class="form-group" style="margin-left: 20px">
                                            <label class="">
                                                <div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false"
                                                    ...
                                                    <input type="checkbox" checked value="{{ $day }}" name="days[]"
                                                        class="flat-red columnCheck custom_checkbox" style="position: absolute; opacity: 0;">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="points" value="" autocomplete="off">
                                </div>
                            </div>
...
@push('footer-js')
    ...
    <script>
        ...
        $('.custom_checkbox.flat-red').iCheck({
