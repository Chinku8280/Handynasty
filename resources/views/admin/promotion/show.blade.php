<div class="modal-header">
    <h4 class="modal-title">@lang('menu.promotion') @lang('app.detail')</h4>
...
<div class="modal-body">
    <div class="portlet-body">
        <div class="row">
                <div class="col-12">
                    <img src="{{$deal->promotion_image_url}}" class="img img-responsive img-thumbnail" width="100%">
                </div>
                ...
                <div class="col-md-12">
                    <h6 class="text-uppercase">@lang('app.promotionItem')</h6>
                ...
                <div class="col-md-6">
                    <h6 class="text-uppercase">@lang('app.promotionUsedTime')</h6>
                    <p>
                        @if($deal->used_time !='')
                        {{ $deal->used_time }}
                        @else
                ...
                <div class="col-md-6">
                    <h6 class="text-uppercase">@lang('app.age')</h6>
                    <p>{{ $deal->min_age }} - {{ $deal->max_age }}</p>
                </div>

                <div class="col-md-6">
                    <h6 class="text-uppercase">@lang('app.gender')</h6>
                    <p>{{ $deal->gender }}</p>
                </div>
