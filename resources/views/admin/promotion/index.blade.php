        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @if ($user->roles()->withoutGlobalScopes()->first()->hasPermission('create_promotion'))
                        <div class="d-flex justify-content-center justify-content-md-end mb-3">
                            <a href="{{ route('admin.promotion.create') }}" class="btn btn-rounded btn-primary mb-1"><i class="fa fa-plus"></i> @lang('app.createNew')</a>
                        </div>
                    @endif
        ...
        <div class="modal-dialog modal-lg" id="modal-data-application">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">@lang('app.promotion')</h4>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.view-deal', function() {
                ...
                var url = "{{ route('admin.promotion.show',':id') }}";
            ...
            $('body').on('click', '.delete-row', function(){
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            var url = "{{ route('admin.promotion.destroy',':id') }}";
                            url = url.replace(':id', id);
